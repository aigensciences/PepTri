...
import models  # Import models to register AutoEncoder
import trainer  # Import trainer to register trainers
...
def load_ckpt(model, ckpt):
    ...
    trained_model = load_checkpoint_with_module_mapping(ckpt, map_location='cpu')
